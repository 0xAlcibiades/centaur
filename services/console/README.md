...
| `CENTAUR_CONSOLE_PERMISSION_REQUEST_APPROVAL_CHANNEL_ID` | for permission requests | Slack channel ID where sandbox permission requests are sent for admin review. |
