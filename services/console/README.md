...
| `CENTAUR_CONSOLE_PERMISSION_REQUEST_APPROVAL_CHANNEL_ID` | optional | Slack channel ID where sandbox permission requests are sent for admin review. Unset disables approver-channel notifications. |
