...
const SYSTEM_PROMPT = [
  ...
  'Map Claude model aliases to canonical IDs: fable -> claude-fable-5, opus -> claude-opus-4-8, opus 4.7 -> claude-opus-4-7, opus 5 fast -> anthropic/claude-opus-5-fast, sonnet -> claude-sonnet-4-6, sonnet 5 -> claude-sonnet-5, haiku -> claude-haiku-4-5. Opus 5 Fast uses harness codex and provider openrouter.',
